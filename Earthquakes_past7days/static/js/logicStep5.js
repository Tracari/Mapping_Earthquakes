...
// and Then we add a control to the map that will allow the user to change
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_day.geojson").then(function(data) {
    ...
    // Then we add the earthquake layer to mao
...
legend.onAdd = function () {
    ...
    let div = L.DomUtil.create('div', 'info legend')};
        const magnitudes = [0, 10, 20, 50, 100, 200, 500, 1000];
        const colors = [
            "#98ee00",
            "#d4ee00",
            "#eecc00",
